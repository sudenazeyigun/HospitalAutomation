...
public class RegisterGUI extends JFrame {
	...
	public RegisterGUI() {
		...
		btn_register.addActionListener(new ActionListener() {
			...
			try {
				boolean kontrol = hasta.register(fld_tcno.getText(), fld_pass.getText(), fld_name.getText());
		...
		btn_register.setFont(new Font("Sitka Subheading", Font.BOLD, 16));
		btn_register.setBounds(10, 209, 240, 27);
		...
		btn_backto.setFont(new Font("Sitka Subheading", Font.BOLD, 16));
		btn_backto.setBounds(10, 246, 240, 27);
